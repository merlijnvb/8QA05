...
@author: irisalmekinders en Niels van Noort
"""
...
def Daysdict(Dagen,r_filter=0.7):
    ...
    for ID in Dagen[0]:
        ...
        for i in range(len(Day_numbers)):
            ...
            if Dagen[i][ID][-1] < r_filter: Filterinfo[ID][3] +=1 # counter voor hoevaak r < filterwaarde
...
def bar_plots(rDict,r_filter=0.7,movement = 256):
