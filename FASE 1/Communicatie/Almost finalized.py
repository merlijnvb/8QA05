...
def writefile(rDict,filename,parse):
    ...
    print(filename+": "+str(len(outstring.split("\n"))))
...
def Main():
    ...
    # bar_plots(rDict,0.5)
    # plot_phase1(Dagen)
    writefile(rDict,"unfiltered_clusterdata.txt","  ")
    writefile(filtered_rDict,"clusterdata.txt","  ")
Main()
